	...
	<body>
		...
		<div>
			<div class="col-md-6 offset-sm-3 _form">
				<form method="post" action="process.php" class="shadow p-4 mb-4 bg-white rounded staffForm">
					...
					<div class="form-group row">
						...
						<div class="col">
							<label>Joined</label>
							<input class="form-control" type="number" name="joined" value="<?php echo $joined; ?>">
						</div>

						<div class="col">
							<label>Salary</label>
							<input class="form-control" type="number" name="salary" value="<?php echo $salary; ?>">
						</div>
		...
		<div class="container-fluid">
			<?php 
				...
				$results = $mysqli->query("SELECT * FROM staff") or die ($mysqli->error);
			...
			<div class="row justify-content-center">
				<table class="table table-striped staffTable" id="mydataTable">
					...
					<tbody>
						<?php while($row = $results-> fetch_assoc()): ?>
							<tr>
								...
								<td class="align-middle"><?php echo $row['joined']?></td>
								<td class="align-middle"><?php echo $row['salary']?></td>
								<td class="align-middle"><?php echo $row['position']?></td>
								<td class="align-middle">
									<a href="testingStaff.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">Edit</a>
